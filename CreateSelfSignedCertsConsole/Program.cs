...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        // private key
        var exportRsaPrivateKeyPem = iec.PemExportRsaPrivateKey(rsaCert);
        File.WriteAllText($"cert_rsa512.key", exportRsaPrivateKeyPem);

        // public key certificate as pem
        var exportPublicKeyCertificatePem = iec.PemExportPublicKeyCertificate(rsaCert);
        File.WriteAllText($"cert_rsa512.pem", exportPublicKeyCertificatePem);
